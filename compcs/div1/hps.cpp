...
int main() {
	...
	int ans = 0;
	ckmax(ans, solve(a, b, {0,1,2}));
	ckmax(ans, solve(a, b, {0,2,1}));
	ckmax(ans, solve(a, b, {1,0,2}));
	ckmax(ans, solve(a, b, {1,2,0}));
	ckmax(ans, solve(a, b, {2,0,1}));
	ckmax(ans, solve(a, b, {2,1,0}));
	outs(ans);
}